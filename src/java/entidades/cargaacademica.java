...
public class cargaacademica {
    ...
    public ArrayList<cargaacademica> getGet_all_category(){
        
          ArrayList<cargaacademica> list_of_categories = new ArrayList<cargaacademica>();
        ...
        try {
             ...
             while (rs.next()) {                
                cargaacademica objCategory = new cargaacademica();
    ...
    public String edit_Category(){
     ...
     try {
          ...
          cargaacademica obj_Category=new cargaacademica();
          rs.next();
